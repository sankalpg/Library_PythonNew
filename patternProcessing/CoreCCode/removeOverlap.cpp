...
{
    FILE *fp1;
    char *patternInfoExt, *patternKNNExt, *filelistFilename, blackListPatternExt, searchFileNames[2000][400] = {'\0'}, tempFilename[400]= {'\0'};
    int verbos =1, ii, nPatterns, NFilesSearch, NPairs;
